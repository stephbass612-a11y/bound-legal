...
<body>
  ...
  <p>This privacy policy applies to the Bound app (hereby referred to as "Application") for mobile devices that was created by Stephanie Bassock (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
  <br>
  ...
  <br>
  <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to email, username, full name, date of birth. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
  <br>
  ...
  <div>
    ...
    <ul>
      ...
      <li><a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google Gemini (AI Service)</a></li>
    </ul>
  </div>
  <br>
  ...
  <p>The Application uses Artificial Intelligence (AI) technologies, specifically Google Gemini, to enhance user experience and provide personalized book recommendations. The AI components process specific user data, including book preferences, favorite genres, and reading history, to deliver these personalized recommendations and summaries.</p>
  <p>No personally identifiable information (such as email or name) is used for AI model training. All AI processing is performed in accordance with this privacy policy and applicable laws. If you have questions about the AI features or data processing, please contact the Service Provider.</p>
  <br>
  <strong>Opt-Out Rights</strong>
  <p>You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.</p>
  <br>
  <strong>Data Retention Policy</strong>
  <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at customersupport@bound.com and they will respond in a reasonable time.</p>
  <br>
  ...
  <div>
    <br>
    <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (customersupport@bound.com) so that they will be able to take the necessary actions.</p>
  </div>
  <br>
  ...
  <br>
  <p>This privacy policy is effective as of 2026-01-24</p>
  <br>
  ...
  <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at customersupport@bound.com.</p>
</body>
</html>
